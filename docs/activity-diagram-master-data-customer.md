# Activity Diagram Master Data Customer

## 1. Deskripsi
Activity Diagram ini menggambarkan alur proses bisnis secara garis besar pada modul pengelolaan **Master Data Customer**. Proses mencakup aktivitas Administrator ketika melihat daftar data customer, memilih aksi pengelolaan (seperti Tambah, Edit, atau Hapus data), hingga sistem memvalidasi dan menyimpan perubahan. Diagram ini disusun secara sekuensial dan fokus pada alur *User Flow* bisnis tanpa melibatkan elemen teknis internal.
...
## 3. Alur Proses
1. Administrator membuka halaman Master Data Customer.
2. Sistem menampilkan daftar data customer.
...
9. Jika valid (berhasil):
   ...
   - Sistem memperbarui daftar data customer dan menampilkan pesan sukses.
10. Proses selesai.
...
<mxfile host="app.diagrams.net" modified="2026-07-04T00:00:00.000Z" agent="Codex" version="27.0.5">
  <diagram id="activity-master-customer" name="Activity Diagram">
    <mxGraphModel dx="1178" dy="633" grid="1" gridSize="10" guides="1" tooltips="1" connect="1" arrows="1" fold="1" page="1" pageScale="1" pageWidth="827" pageHeight="1169" math="0" shadow="0">
      <root>
        ...
        <mxCell id="2" parent="1" style="swimlane;html=1;startSize=30;horizontal=1;rounded=0;swimlaneLine=1;fillColor=#ffffff;strokeColor=#000000;fontStyle=1;" value="Kelola Master Data Customer" vertex="1">
        ...
        <mxCell id="11" parent="3" style="rounded=1;whiteSpace=wrap;html=1;arcSize=18;fillColor=#ffffff;strokeColor=#000000;" value="Membuka halaman&lt;br&gt;Master Data Customer" vertex="1">
        ...
        <mxCell id="12" parent="4" style="rounded=1;whiteSpace=wrap;html=1;arcSize=18;fillColor=#ffffff;strokeColor=#000000;" value="Menampilkan daftar&lt;br&gt;data customer" vertex="1">
...
```plantuml
@startuml
title Kelola Master Data Customer
skinparam monochrome true
skinparam shadowing false

|Administrator|
start
:Membuka halaman Master Data Customer;

|Sistem|
:Menampilkan daftar data customer;
...
```mermaid
flowchart TD
    subgraph AD["Kelola Master Data Customer"]
        direction TB

        subgraph A["Administrator"]
            direction TB
            A0([Start])
            A1[Membuka halaman Master Data Customer]
        ...
        subgraph S["Sistem"]
            direction TB
            S1[Menampilkan daftar data customer]
...
## 7. Catatan Validasi
- Ketiga format diagram menggambarkan alur pengelolaan **Master Data Customer** secara konsisten.
