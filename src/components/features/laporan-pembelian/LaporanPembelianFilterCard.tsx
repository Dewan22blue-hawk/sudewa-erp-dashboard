...
export default function LaporanPembelianFilterCard() {
    ...
    const handleSubmit = () => {
        ...
        router.push(
            `/dashboard/${slug}/laporan/laporan-pembelian/${jenis}?awal=${awal.toISOString()}&akhir=${akhir.toISOString()}`
        )
    }
