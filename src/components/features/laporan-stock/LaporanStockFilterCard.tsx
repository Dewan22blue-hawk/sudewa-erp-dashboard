...
export default function LaporanStockFilterCard() {
    ...
    const [jenis, setJenis] = useState<JenisLaporanStock | "">("")
    ...
    const handleSubmit = () => {
        ...
        router.push(
            `/dashboard/${slug}/laporan/laporan-stock/${jenis}?awal=${awal.toISOString()}&akhir=${akhir.toISOString()}`
        )
    }
            ...
            <div className="flex flex-col space-y-6">
                ...
                <div className="flex items-center">
                    ...
                    <div className="w-[300px]">
                        <Select value={jenis} onValueChange={(val) => setJenis(val as JenisLaporanStock)}>
                            <SelectTrigger className="w-full bg-white border-gray-200">
                                <SelectValue placeholder="Pilih jenis laporan" />
                            </SelectTrigger>
                            <SelectContent>
                                <SelectItem value="laporan-stock">
                                    Laporan Stock
                                </SelectItem>
                                <SelectItem value="laporan-stock-detail">
                                    Laporan Stock Detail
                                </SelectItem>
                                <SelectItem value="po-outstanding">
                                    Purchase Order Outstanding
                                </SelectItem>
                                <SelectItem value="so-outstanding">
