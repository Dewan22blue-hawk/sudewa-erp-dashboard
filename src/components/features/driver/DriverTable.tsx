...
import { DriverFormData } from './DriverFormModal';
                ...
                <div className="overflow-x-auto">
                    <Table className="min-w-[1000px]">
                        <TableHeader className="bg-[#f8f9fa] border-b border-gray-200">
                            <TableRow>
                                <TableHead className="text-xs font-semibold text-gray-600 uppercase text-center py-3">NAMA DRIVER</TableHead>
                                ...
                                <TableHead className="text-xs font-semibold text-gray-600 uppercase text-center py-3">KTP</TableHead>
                                <TableHead className="text-xs font-semibold text-gray-600 uppercase text-center py-3">SIM</TableHead>
                                ...
                                drivers.map((driver) => (
                                    <TableRow key={driver.id} className="hover:bg-gray-50/50">
                                        ...
                                        <TableCell className="px-4 py-4 text-sm text-gray-600 text-center">
                                            <span className="line-clamp-2 max-w-[200px] mx-auto">{driver.alamat}</span>
                                        </TableCell>
                                        ...
                                        <TableCell className="px-4 py-4 text-sm text-center">
                                            <DropdownMenu>
                                                ...
                                                <DropdownMenuContent align="end" className="w-[160px]">
                                                    ...
                                                    <DropdownMenuItem onClick={() => onDelete(driver)} className="text-red-600 cursor-pointer focus:text-red-600">
                                                        Hapus
                                                    </DropdownMenuItem>
                                                </DropdownMenuContent>
                                            </DropdownMenu>
