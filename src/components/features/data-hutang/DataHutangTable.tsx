        ...
        <table className="w-full text-sm">
          <thead className="bg-gray-50/50 uppercase text-sm font-semibold text-gray-900 leading-normal">
            <tr className="border-b border-gray-200">
              ...
              <th className="py-2 text-left">NO PEMBELIAN</th>
              <th className="py-2 text-left">TANGGAL</th>
              <th className="py-2 text-left">NAMA SUPPLIER</th>
              <th className="py-2 text-right">TOTAL BELI</th>
              <th className="py-2 text-right">TOTAL BAYAR</th>
              <th className="py-2 text-right">AMOUNT HUTANG</th>
