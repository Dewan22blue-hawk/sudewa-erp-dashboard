...
export const getReceiptStatusLabel = (item: GoodsReceiptEquipment) => {
...
export const getReceiptBilling = (receipt?: GoodsReceiptEquipmentDetail | null): GoodsReceiptEquipmentBilling | null => {
