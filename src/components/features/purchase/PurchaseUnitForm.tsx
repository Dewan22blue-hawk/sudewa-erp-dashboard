            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <FormItem>
                        ...
                        <FormControl>
                            <Input
                                value={`Rp ${totalDpp.toLocaleString('id-ID')}`}
                                className="bg-muted/50"
                                disabled
                                readOnly
                            />
                    ...
                    <FormItem>
                        ...
                        <FormControl>
                            <Input
                                value={`Rp ${totalPpn.toLocaleString('id-ID')}`}
                                className="bg-muted/50"
                                disabled
                                readOnly
                            />
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <FormItem>
                        ...
                        <FormControl>
                            <Input
                                value={`Rp ${hppSatuan.toLocaleString('id-ID')}`}
                                className="bg-muted/50"
                                disabled
                                readOnly
                            />
                    ...
                    <FormItem>
                        ...
                        <FormControl>
                            <Input
                                value={`Rp ${dppSatuan.toLocaleString('id-ID')}`}
                                className="bg-muted/50"
                                disabled
                                readOnly
                            />
                    ...
                    <FormItem>
                        ...
                        <FormControl>
                            <Input
                                value={`Rp ${ppnSatuan.toLocaleString('id-ID')}`}
                                className="bg-muted/50"
                                disabled
                                readOnly
                            />
