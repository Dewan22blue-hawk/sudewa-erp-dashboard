            ...
            <div className="overflow-hidden rounded-xl border border-slate-200 bg-white">
                <Table>
                    <TableHeader className="bg-slate-50">
                        <TableRow>
                            <TableHead className="font-semibold uppercase text-slate-700">User ID</TableHead>
                            <TableHead className="font-semibold uppercase text-slate-700">Nama Pengguna</TableHead>
                            <TableHead className="font-semibold uppercase text-slate-700">Role</TableHead>
                        ...
                        {currentData.length === 0 ? (
                            ...
                            currentData.map((user) => (
                                <TableRow key={user.id} className="hover:bg-slate-50/50">
                                    <TableCell className="font-medium text-slate-800">{user.userId}</TableCell>
