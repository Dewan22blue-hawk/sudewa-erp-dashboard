...
export function SalesRefundForm({
  ...
  const totalSales = Number(
    sales.unit_transaction_bruto_total ?? sales.unit_transaction_item_bruto_total ?? 0,
  );
      ...
      <CardContent className="p-6 md:p-8">
        <Form {...form}>
          <form onSubmit={form.handleSubmit(handleFormSubmit)} className="space-y-6">
            ...
            {/* ── Row 1: Kode Penjualan | Customer | Tanggal Refund ── */}
            <div className="grid grid-cols-1 gap-5 md:grid-cols-3">
              {/* Kode Penjualan */}
              <div className="space-y-2">
                <FormLabel className="text-sm font-medium text-slate-700">Kode Penjualan</FormLabel>
                <Input
                  value={sales.code}
                  readOnly
            ...
            {/* ── Row 2: Total Penjualan | Telah Dibayar ── */}
            <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
              <div className="space-y-2">
                <FormLabel className="text-sm font-medium text-slate-700">Total Penjualan</FormLabel>
                <Input
