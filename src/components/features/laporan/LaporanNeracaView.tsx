...
export default function LaporanNeracaView() {
  return (
    <div className="space-y-8 max-w-4xl mx-auto">
      ...
      <div className="bg-white border rounded-xl p-12 shadow-sm relative">
        ...
        <div className="w-full text-xs sm:text-sm">
          {/* Header AKTIVA */}
          <div className="bg-[#e6f4ea] text-center font-semibold py-2 w-full mb-2">AKTIVA</div>
        ...
        <div className="text-center mt-12 text-xs text-gray-400">1</div>
      </div>
      ...
      <div className="bg-white border rounded-xl p-12 shadow-sm relative">
        ...
        <div className="w-full text-xs sm:text-sm">
          {/* Header PASIVA */}
          <div className="bg-[#dbeafe] text-center font-semibold py-2 w-full mb-2">PASIVA</div>
        ...
        <div className="text-center mt-12 text-xs text-gray-400">2</div>
      </div>
    </div>
  );
}
