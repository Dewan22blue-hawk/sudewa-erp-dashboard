                      ...
                      <TableCell className="px-4 py-3 text-center">
                        <DropdownMenu>
                          ...
                          <DropdownMenuContent align="end" className="w-[162px] rounded-[14px] border border-[#E5E7EB] p-2 shadow-[0_12px_35px_rgba(15,23,42,0.14)]">
                            ...
                            <DropdownMenuItem className="rounded-[10px] px-4 py-3 text-sm text-[#111827]" onClick={() => router.push(`/dashboard/${slug}/transaksi/pembelian-unit/${transactionId}/refund/${refund.id}`)}>
                              Detail
                            </DropdownMenuItem>
