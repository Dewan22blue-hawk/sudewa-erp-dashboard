...
export default function LaporanPenerimaanPerNotaView({ data }: Props) {
    return (
        <div className="bg-white border rounded-xl p-12 max-w-4xl mx-auto shadow-sm">
            ...
            <div className="flex flex-col items-center justify-center mb-10 relative">
                ...
                <div className="text-center space-y-1">
                    <h2 className="font-bold text-lg">LAPORAN PENERIMAAN PER NOTA</h2>
            ...
            <table className="w-full text-sm">
                <thead>
                    <tr className="border-b-2 border-gray-200">
                        ...
                        <th className="text-left font-semibold py-3 px-4">Penerima</th>
                ...
                <tbody>
                    {data?.map((item, index) => (
                        <tr key={index} className="border-b border-gray-100 hover:bg-gray-50">
                            ...
                            <td className="py-2.5 px-4 text-gray-600">{item.penerima}</td>
