    ...
    >
      ...
      >
        ...
        >
          ...
          <div className="absolute -left-8 -top-8 w-16 h-16 bg-pink-100 rounded-3xl shadow-clay border-4 border-white flex items-center justify-center text-pink-500 z-30">
            <Laugh size={32} />
          </div>
          <div className="absolute -right-6 top-20 w-14 h-14 bg-amber-100 rounded-2xl shadow-clay border-4 border-white flex items-center justify-center text-amber-500 z-30">
            <Gamepad2 size={24} />
          </div>
          <div className="absolute -left-4 bottom-20 w-12 h-12 bg-blue-100 rounded-full shadow-clay border-4 border-white flex items-center justify-center text-blue-500 z-30">
            <Mic size={20} />
          </div>
