...
function Calendar({ className, classNames, showOutsideDays = true, ...props }: CalendarProps) {
  ...
  return (
    <DayPicker
      ...
      className={cn('p-3 bg-white rounded-md shadow-md text-foreground', className)}
      classNames={{
        ...
        day_range_start: 'day-range-start bg-primary text-white hover:bg-primary hover:text-white focus:bg-primary focus:text-white',
        day_range_end: 'day-range-end bg-primary text-white hover:bg-primary hover:text-white focus:bg-primary focus:text-white',
