...
const Toaster = ({ ...props }: ToasterProps) => {
  ...
  return (
    <Sonner
      ...
      toastOptions={{
        classNames: {
          toast: 'group toast rounded-md border shadow-2xl backdrop-blur-xl bg-white/70 dark:bg-primary/70 border-white/20 dark:border-white/10 z-[1000] p-4 pr-8 flex items-center gap-4 relative',
