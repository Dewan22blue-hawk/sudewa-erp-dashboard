    ...
    <DashboardLayout>
      ...
      <div className="p-6">
        <div className="flex justify-between items-start mb-6">
          ...
          <Button onClick={() => setIsAddOpen(true)} className="bg-[#1e293b] hover:bg-[#0f172a] gap-2">
            <Plus size={18} />
            Tambah
          </Button>
        </div>
        ...
        <div className="flex justify-between items-center mb-4">
          <div className="flex items-center gap-4">
            <div className="relative w-75">
              ...
              <Input placeholder="Search here" className="pl-10 bg-white" value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)} />
            </div>
