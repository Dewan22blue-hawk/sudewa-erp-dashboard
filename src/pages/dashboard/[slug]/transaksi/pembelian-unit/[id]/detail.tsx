      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between print:hidden">
          <div className="flex items-start gap-4">
            <Button variant="ghost" size="icon" className="mt-1 h-8 w-8" onClick={() => router.push(`/dashboard/${slug}/transaksi/pembelian-unit`)}>
            ...
            <div className="space-y-1">
              ...
              <div className="flex items-center gap-2 text-sm">
                ...
                <span className="font-medium text-blue-600">{purchase.code}</span>
              </div>
            </div>
          </div>

          <div className="flex gap-3 ml-12 md:ml-0">
            <Button variant="outline" className="bg-white hover:bg-gray-50 text-black border-input" onClick={() => router.push(`/dashboard/${slug}/transaksi/pembelian-unit/${purchase.id}/payment`)}>
              <span className="mr-2 font-semibold text-lg leading-none">$</span>
              Bayar
            </Button>
            <Button className="bg-gray-100 hover:bg-gray-200 text-black border-input border" onClick={() => router.push(`/dashboard/${slug}/transaksi/pembelian-unit/${purchase.id}/add-unit`)}>
