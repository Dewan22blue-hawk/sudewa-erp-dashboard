...
import { useBulkDeleteDetail, useBulkTerimaDetail, usePenerimaanDetail, usePenerimaanUnitById } from '@/hooks/usePenerimaanUnit';
      ...
      <div className="space-y-6">
        <div className="flex flex-col gap-1">
          ...
          <p className="text-sm text-gray-500 pl-8">
            No Pemesanan <span className="text-blue-500 font-medium">{header?.noPenerimaan || '-'}</span>
          </p>
        </div>

        {isLoading || !header ? <div className="p-8 text-center text-gray-500">Loading...</div> : <PenerimaanUnitHeaderCard data={header} />}
