...
import { usePengeluaranUnitById, usePengeluaranDetail, useBulkDeleteDetail, useUpdatePengeluaranUnit } from '@/hooks/usePengeluaranUnit';
  ...
  return (
    <DashboardLayout>
      <div className="space-y-6">
        ...
        {isLoading || !header ? <div className="p-8 text-center text-gray-500 bg-white rounded-xl border border-gray-100">Loading...</div> : <PengeluaranUnitHeaderCard data={form} onChange={handleFieldChange} onBlur={handleSaveField} />}

        <div className="bg-white rounded-xl border border-gray-200 p-6 space-y-4">
          {loadingDetail ? <div className="p-8 text-center text-gray-500">Memuat detail...</div> : <PengeluaranUnitEditTable data={details} onDelete={handleDeleteTable} />}
        </div>
        ...
        <div className="flex justify-center items-center gap-4 mt-8 pb-4">
          ...
          <Button onClick={handleSimpanClick} className="px-6 h-10 bg-[#1e3256] hover:bg-[#15233d] text-white font-medium rounded-lg shadow-sm gap-2">
