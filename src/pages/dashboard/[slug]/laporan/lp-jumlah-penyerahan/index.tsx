                          ...
                          data.map((item, idx) => {
                            ...
                            return (
                              <TableRow key={item.id} className="border-slate-200 hover:bg-gray-50 transition-colors">
                                ...
                                {/* Dates rendering */}
                                <TableCell className="text-slate-600 whitespace-nowrap text-sm">{tglDaftar}</TableCell>
                                <TableCell className="text-slate-600 whitespace-nowrap text-sm">{formatDateString(item.stnk_received_date)}</TableCell>
                                <TableCell className="text-slate-600 whitespace-nowrap text-sm">{formatDateString(item.bpkb_received_date)}</TableCell>
                                <TableCell className="text-slate-600 whitespace-nowrap text-sm">{formatDateString(item.customer_delivery_date)}</TableCell>
                              </TableRow>
                            );
                          })
                        ) : (
