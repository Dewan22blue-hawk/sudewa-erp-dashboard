    ...
    <DashboardLayout>
      <div className="p-6 space-y-6 bg-white min-h-screen laporan-penerimaan-page">
        ...
        <div className="flex justify-between items-start no-print">
          <div>
            <h1 className="text-[28px] font-bold text-gray-900 tracking-tight leading-none mb-2">Laporan Jumlah Outstanding</h1>
            <p className="text-[15px] text-gray-500">Laporan jumlah data outstanding dokumen kendaraan</p>
          </div>
                          ...
                          data.map((item, idx) => {
                            ...
                            return (
                              <TableRow key={item.id} className="border-slate-100 hover:bg-slate-50/50">
                                ...
                                <TableCell className="whitespace-nowrap">{renderOutstandingStatusBadge(statusText)}</TableCell>
