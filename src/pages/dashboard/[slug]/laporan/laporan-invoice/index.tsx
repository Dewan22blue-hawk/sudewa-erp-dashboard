    ...
    <DashboardLayout>
      <div className="space-y-6 px-1">
        ...
        <div className="flex justify-between items-start no-print">
          <div>
            <h1 className="text-2xl font-semibold text-slate-900">Laporan Invoice</h1>
            <p className="text-sm text-slate-500 mt-1">Laporan data invoice ekspedisi</p>
          </div>
                  ...
                  <Table>
                    <TableHeader className="bg-slate-50 border-b border-slate-200">
                      <TableRow className="hover:bg-transparent">
                        ...
                        <TableHead className="text-xs font-bold uppercase text-slate-700 whitespace-nowrap">TUJUAN</TableHead>
                        <TableHead className="text-xs font-bold uppercase text-slate-700 whitespace-nowrap">LOADING OUT</TableHead>
                        <TableHead className="text-xs font-bold uppercase text-slate-700 whitespace-nowrap">INV EKSPEDISI</TableHead>
                        <TableHead className="text-xs font-bold uppercase text-slate-700 whitespace-nowrap">BIAYA</TableHead>
                        ...
                        data.map((item, idx) => {
                          ...
                          return (
                            <TableRow key={item.uuid || idx} className="border-slate-100 hover:bg-slate-50/50">
                              ...
                              <TableCell className="font-semibold text-slate-800 whitespace-nowrap">{formatMoney(invoiceExpedition, 'IDR')}</TableCell>
                              <TableCell className="font-semibold text-slate-800 whitespace-nowrap">{formatMoney(biaya, 'IDR')}</TableCell>
