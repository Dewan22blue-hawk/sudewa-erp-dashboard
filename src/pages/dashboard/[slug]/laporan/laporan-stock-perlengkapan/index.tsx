    ...
    <DashboardLayout>
      <div className="p-6 space-y-6 bg-white min-h-screen laporan-penerimaan-page">
        ...
        <div className="flex justify-between items-start no-print">
          <div>
            <h1 className="text-[28px] font-bold text-gray-900 tracking-tight leading-none mb-2">Laporan Stock Perlengkapan</h1>
            <p className="text-[15px] text-gray-500">Laporan stock perlengkapan, penerimaan barang, dan pengeluaran barang</p>
          </div>
