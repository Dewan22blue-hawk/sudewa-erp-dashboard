...
export default function LaporanAkuntansiPage() {
    ...
    const getReportTitle = () => {
        switch (type) {
            case "rugi-laba": return "Laporan Rugi Laba"
            case "neraca": return "Neraca"
            case "ppn-masukan-perbulan": return "Laporan PPN Masukan Perbulan"
            case "ppn-keluaran-perbulan": return "Laporan PPN Keluaran Perbulan"
            case "ppn-pertahun": return "Laporan PPN Pertahun"
            default: return "Laporan Akuntansi"
        }
    }
    ...
    const renderReportView = () => {
        ...
        return (
            <div className="bg-white border rounded-xl p-8 text-center text-gray-500">
                Silahkan pilih laporan dari menu sebelumnya atau sedang dalam pengembangan.
            </div>
        )
    }
            ...
            <div className="p-6 space-y-6">
                <div className="flex justify-between items-start">
                    <div className="flex items-center gap-3">
                        <button
                            onClick={() => router.push(`/dashboard/${slug}/laporan/laporan-akuntansi`)}
